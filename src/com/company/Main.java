...
//        for(int i = 1; i <= 6; i++){
//            db_ticket.create_table_ticket(conn, "tab" + i);
//            db_ticket.insert_row(conn, "tab" + i, "07:15", "09:15", 40, 25000);
//            db_ticket.insert_row(conn, "tab" + i, "14:20", "16:00", 25, 24000);
//            db_ticket.insert_row(conn, "tab" + i, "21:20", "22:50", 35, 20000);
//            db_ticket.insert_row(conn, "tab" + i, "17:15", "19:00", 15, 24000);
//            db_ticket.insert_row(conn, "tab" + i, "09:05", "10:50", 10, 24000);
//        }
